...
const { insertarProductoController, actualizarProductoController, eliminarProductoController, actualizarImagenProductoController } = require("../controlador/productoControlador");
